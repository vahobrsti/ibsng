...
{addEditTable title="Internet Charge Rule" double="TRUE" table_width=580}
	    ...
	    {/addEditTD}
	    {addEditTD type="right2" double="TRUE"}
		<input class="medium_text" type=text name=bandwidth_limit_kbytes value="{ifisinrequest name="bandwidth_limit_kbytes" default_var="bandwidth_limit" default=0}"> <FONT SIZE=1>MBytes</FONT>
	    {/addEditTD}
