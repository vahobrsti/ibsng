...
class AddNewTariff extends Request
{
    ...
    {
        parent::__construct("voip_tariff.addNewTariff", array("tariff_name" => $tariff_name, "comment" => $comment));
    }
}
...
class UpdateTariff extends Request
{
    ...
    {
        parent::__construct("voip_tariff.updateTariff", array("tariff_name" => $tariff_name, "tariff_id" => $tariff_id, "comment" => $comment));
    }
}
...
class DeleteTariff extends Request
{
    ...
    {
        parent::__construct("voip_tariff.deleteTariff", array("tariff_name" => $tariff_name));
    }
}
...
class AddPrefix extends Request
{
    ...
    {
        parent::__construct("voip_tariff.addPrefix", array(
...
class UpdatePrefix extends Request
{
    ...
    {
        parent::__construct("voip_tariff.updatePrefix", array(
            "tariff_name" => $tariff_name,
            "prefix_id" => $prefix_id,
...
class DeletePrefix extends Request
{
    ...
    {
        parent::__construct("voip_tariff.deletePrefix", array("tariff_name" => $tariff_name, "prefix_code" => $prefix_code));
    }
}
...
class GetTariffInfo extends Request
{
    ...
    {
        parent::__construct("voip_tariff.getTariffInfo", array("tariff_name" => $tariff_name, "include_prefixes" => $include_prefixes, "name_regex" => $name_regex));
    }
}
...
class ListTariffs extends Request
{
    ...
    {
        parent::__construct("voip_tariff.listTariffs", array());
    }
}
?>
